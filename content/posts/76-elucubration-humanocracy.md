...
After writing the [Workplace Cultures post](https://www.mseri.me/workplace-cultures/), I was listening to the [No Nonsense Agile Leadership](https://nononsenseagile.podbean.com/e/nn-0116-humanocracy-with-michele-zanini/) podcast (episode #0116, linked here, if you are curious). The guest was Michele Zanini, co-author with Gary Hamel of [Humanocracy](https://www.humanocracy.com/).
...
But if we look past the corporate framing, we could revisit humanocracy as a set of driving values that align with the specificity of the organization. The principles, by design, are meant to be translated into something suitable with the target institution. In this case, it should be a translation that resonates with academic needs and values before being applied.
...
My answer, which I hope I was able to explain already, is that the corporate vocabulary is beside the point. Strip it away, apply a little translation, and what remains is a claim about the kind of environment that allows people to collaborate, think out loud, take intellectual risks, and produce meaningful work. In that light, humanocracy is a description of what the university was always supposed to be: a self-governing, dynamic community of scholars, trusted to pursue difficult questions and accountable to their peers and to the pursuit of truth.

This sounds to me perfectly in line with the original aim of [Universitas](https://en.wikipedia.org/wiki/Medieval_university). Fundamentally, these were communities of equals working together toward a shared interest in knowledge and its dissemination. So in this sense, adopting humanocracy in academia doesn't sound like a revolution at all. These seven principles aren't new inventions. They are a modern formulation of dynamics that have animated university departments in the past, polished by a safer, more inclusive, and collegial atmosphere.

I feel like I have been digging to find something new and ended up with an archaeological discovery. But are we willing to restore the ruins by promoting structures that make our values real, fostering leaner processes and a stronger dialogue with society? Or will we just keep inscribing our values on strategy webpages while we sit in yet another meeting to schedule the next meeting?
...
There remains the issue of leadership. Somehow the way self selection works at university seems to drive a lot of selfishness and egocentrism, which may harm this whole thought experiment and do a favour to bureaucratic centralization. Zanini emphasizes more than once, and makes an important point of this in the examples in the book, that changing the culture and educating the leadership go hand in hand. So perhaps that is where we should start...
