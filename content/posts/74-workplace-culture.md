...
Of course there are ongoing steps in the right direction, look at [DORA](https://sfdora.org/) or [Recognition and Rewards (Erkennen en Waarderen)](https://recognitionrewards.nl/) here in the Netherlands. But they are, so far (and in most cases), more used as HR slogans than anything else.
