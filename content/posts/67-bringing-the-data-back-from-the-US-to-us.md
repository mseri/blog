...
I like their VPN a lot, and heard excellent reviews of their mail. However, for what concerns the Drive, I regularly bump into mixed reviews, describing similar issues. I would probably test it carefully for a bit before buying it. 
My main worry with it, is that it seems to be a one-person company, so I am not sure how sustainable will be in the long run.
So far it has proven to be quite reliable though, so it may just be a non-worry.
...
I have not tested it personally, but it also seems an interesting option and had very good reviews. Especially for backup needs, it supports rclone, which is a plus for me.
...
It is perfect for keeping your own devices in sync without trusting a third‑party host, but by design it does not solve the “I need a hosted collaboration space” problem.
