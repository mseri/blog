...
What is peculiar about conditionally convergent series, is that it is possible to rearrange the terms in the sequence so that the sum of the rearrangement converges to any arbitary number. This is called [**Riemann's rearrangement theorem**](https://en.wikipedia.org/wiki/Riemann_series_theorem).
...
{{< rawhtml >}}
<iframe src="https://www.mseri.me/rearrangements/" width="100%" frameborder="0"></iframe>
{{< /rawhtml >}}
