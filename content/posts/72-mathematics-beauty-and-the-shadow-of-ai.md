...
From this perspective, mathematical truth isn't an empirical fact we trip over in the woods; it's an artifact of a language we have collectively engineered to help us deliberate reliably with one another. Truth, in this sense, has the "dignity of a rule" (Wittgenstein).

I needed quite some time to understand what this even means, but I think it is a way to say that it functions as a transcendental norm: not something we discover within experience but something that structures the very possibility of there being experience at all.
...
- [Minas Karamanis](https://ergosphere.blog/posts/the-machines-are-fine/) has some deep thoughts on something that touches close to this topic, with an overlap with my previous posts on education or assessment and AI. They make a compelling observation that all successful use of generative AI that recently appeared in the press is successful because it is very closely supervised by experts. Supervision is the key, and we risk moving to a world of curators that can ``produce results but not understanding''. Thankfully, I think people are very diverse, and I am always hopeful that we will end up in a middle ground. But the worry is real, and the post is well thought out. Have a read.

- For Mathematics students, Francis Su has a beautiful piece: [The Enduring Value of Math, in an Age of AI](https://francissu.substack.com/p/the-enduring-value-of-math-in-an)

- The reflection on why we do what we do is affecting many other fields. Here is a very interesting take from Astrophisics: [David W. Hogg -- Why we do astrophysics?](https://arxiv.org/pdf/2602.10181)
